...
const AVATAR_FILLS = ["#F7F4D5", "#D3968C", "#839958", "#D3968C"];
    ...
    <div style={{ backgroundColor: "#F9F7EC", minHeight: "100vh" }}>
      ...
      <header style={{
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <Link href="/auth/login" style={{ fontSize: 13, fontWeight: 700, color: "#839958", textDecoration: "none", backgroundColor: "#0A3323", borderRadius: 8, padding: "7px 16px" }}>
            Get started free →
          </Link>
        </div>
      </header>
      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "88px 48px 72px", textAlign: "center" }}>
        <div style={{ display: "inline-block", backgroundColor: "#0A3323", color: "#839958", fontSize: 12, fontWeight: 700, borderRadius: 99, padding: "6px 18px", marginBottom: 28, letterSpacing: "0.3px" }}>
        ...
        <h1 style={{ fontSize: 52, fontWeight: 800, color: "#1a1a1a", letterSpacing: "-2px", lineHeight: 1.1, margin: "0 0 24px" }}>
          Play the game of{" "}
          <span style={{ color: "#839958" }}>growth.</span>
        </h1>
        <p style={{ fontSize: 17, color: "#839958", lineHeight: 1.75, maxWidth: 520, margin: "0 auto 36px" }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", alignItems: "center" }}>
          <Link href="/auth/login" style={{ fontSize: 15, fontWeight: 800, backgroundColor: "#0A3323", color: "#839958", borderRadius: 10, padding: "14px 28px", textDecoration: "none" }}>
            Start for free →
          </Link>
          <Link href="/experts" style={{ fontSize: 15, fontWeight: 700, backgroundColor: "#F7F4D5", color: "#1a1a1a", borderRadius: 10, padding: "14px 28px", textDecoration: "none" }}>
            Browse experts
          </Link>
        </div>
        <p style={{ fontSize: 12, color: "#b0ab8c", marginTop: 14 }}>No credit card needed</p>
      </section>

      {/* ── Try before you sign up ─────────────────────────────────────── */}
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "0 48px 72px" }}>
        <p style={{ fontSize: 11, fontWeight: 700, color: "#b0ab8c", letterSpacing: "1px", textTransform: "uppercase", marginBottom: 20 }}>
          TRY BEFORE YOU SIGN UP
        </p>
        <div style={{ display: "flex", gap: 16 }}>
          {/* Card 1 — Resume score */}
          <div style={{ flex: "0 0 220px", backgroundColor: "#fff", border: "1px solid #e8e4ce", borderRadius: 14, padding: 16, display: "flex", flexDirection: "column", gap: 10 }}>
            <span style={{ fontSize: 10, fontWeight: 800, backgroundColor: "#F7F4D5", color: "#1a1a1a", borderRadius: 99, padding: "3px 10px", alignSelf: "flex-start" }}>FREE</span>
            <div>
              <p style={{ fontSize: 14, fontWeight: 800, color: "#1a1a1a", margin: "0 0 4px" }}>Resume score</p>
              <p style={{ fontSize: 12, color: "#839958", margin: 0, lineHeight: 1.55 }}>Upload your resume — see your ATS score instantly</p>
            </div>
            <Link href="/resume" style={{ fontSize: 12, fontWeight: 700, color: "#839958", textDecoration: "none", marginTop: "auto" }}>Try now →</Link>
          </div>

          {/* Card 2 — Interview question */}
          <div style={{ flex: "0 0 220px", backgroundColor: "#fff", border: "1px solid #e8e4ce", borderRadius: 14, padding: 16, display: "flex", flexDirection: "column", gap: 10 }}>
            <span style={{ fontSize: 10, fontWeight: 800, backgroundColor: "#D3968C", color: "#5b3fa8", borderRadius: 99, padding: "3px 10px", alignSelf: "flex-start" }}>FREE</span>
            <div>
              <p style={{ fontSize: 14, fontWeight: 800, color: "#1a1a1a", margin: "0 0 4px" }}>Interview question</p>
              <p style={{ fontSize: 12, color: "#839958", margin: 0, lineHeight: 1.55 }}>PM · Swiggy · &quot;Why do you want to join?&quot;</p>
            </div>
            <p style={{ fontSize: 12, color: "#1a1a1a", filter: "blur(4px)", userSelect: "none", margin: 0, pointerEvents: "none" }}>Answer + model response →</p>
            <Link href="/questions" style={{ fontSize: 12, fontWeight: 700, color: "#839958", textDecoration: "none", marginTop: "auto" }}>Practice free →</Link>
          </div>

          {/* Card 3 — Salary check */}
          <div style={{ flex: "0 0 220px", backgroundColor: "#fff", border: "1px solid #e8e4ce", borderRadius: 14, padding: 16, display: "flex", flexDirection: "column", gap: 10 }}>
            <span style={{ fontSize: 10, fontWeight: 800, backgroundColor: "#839958", color: "#0A3323", borderRadius: 99, padding: "3px 10px", alignSelf: "flex-start" }}>FREE</span>
            <div>
              <p style={{ fontSize: 14, fontWeight: 800, color: "#1a1a1a", margin: "0 0 4px" }}>Salary check</p>
              <p style={{ fontSize: 12, color: "#839958", margin: 0, lineHeight: 1.55 }}>PM at Series B · Bangalore</p>
            </div>
            <p style={{ fontSize: 20, fontWeight: 800, color: "#1a1a1a", filter: "blur(5px)", userSelect: "none", margin: 0, pointerEvents: "none" }}>₹18L – ₹28L</p>
            <Link href="/salaries" style={{ fontSize: 12, fontWeight: 700, color: "#839958", textDecoration: "none", marginTop: "auto" }}>Check yours →</Link>
          </div>

          {/* Card 4 — Expert mock interview */}
          <div style={{ flex: "0 0 220px", backgroundColor: "#fff", border: "1px solid #e8e4ce", borderRadius: 14, padding: 16, display: "flex", flexDirection: "column", gap: 10 }}>
            <span style={{ fontSize: 10, fontWeight: 800, backgroundColor: "#0A3323", color: "#839958", borderRadius: 99, padding: "3px 10px", alignSelf: "flex-start" }}>EXPERT</span>
            <div>
              <p style={{ fontSize: 14, fontWeight: 800, color: "#1a1a1a", margin: "0 0 4px" }}>Mock interview</p>
              <p style={{ fontSize: 12, color: "#839958", margin: 0, lineHeight: 1.55 }}>Rohan Mehta · PM · Razorpay</p>
            </div>
            <p style={{ fontSize: 12, color: "#555", margin: 0 }}>47 sessions · ₹999 / session</p>
            <Link href="/experts" style={{ fontSize: 12, fontWeight: 700, color: "#839958", textDecoration: "none", marginTop: "auto" }}>Book session →</Link>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 24 }}>
          {[
            ...
            <div key={label} style={{ textAlign: "center" }}>
              <p style={{ fontSize: 34, fontWeight: 800, color: "#F7F4D5", margin: "0 0 6px", lineHeight: 1 }}>{num}</p>
      ...
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "72px 48px" }}>
        <p style={{ fontSize: 11, fontWeight: 700, color: "#b0ab8c", letterSpacing: "1px", textTransform: "uppercase", marginBottom: 12 }}>FREE AI TOOLS</p>
        ...
        <p style={{ fontSize: 16, color: "#839958", margin: "0 0 48px" }}>Start with AI. Upgrade to a human when you want real feedback.</p>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
          {[
            {
              emoji: "📝", title: "Resume Builder & Analyser",
              bg: "#F7F4D5", color: "#1a1a1a", descColor: "rgba(0,0,0,0.55)",
            ...
            },
            {
              ...
              bg: "#D3968C", color: "#1a1a1a", descColor: "rgba(0,0,0,0.55)",
            ...
            },
            {
              ...
              bg: "#0A3323", color: "#ffffff", descColor: "rgba(255,255,255,0.55)",
              desc: "500+ questions by role and company. Practice with AI, get model answers.",
              badge: { label: "Free", bg: "rgba(131,153,88,0.2)", color: "#839958" },
              href: "/questions",
            },
            {
              emoji: "💰", title: "Salary Intelligence",
              bg: "#ffffff", color: "#1a1a1a", descColor: "#839958", border: "1px solid #e8e4ce",
              desc: "See what your role pays. Contribute your data to unlock full breakdown.",
              badge: { label: "Free", bg: "#e8e4ce", color: "#839958" },
              href: "/salaries",
            },
            {
            ...
            },
            {
              ...
              badge: { label: "Expert", bg: "#0A3323", color: "#839958" },
              href: "/experts",
            },
      ...
      <section style={{ backgroundColor: "#fff", padding: "72px 0" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 48px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 36 }}>
            <div>
              <p style={{ fontSize: 11, fontWeight: 700, color: "#b0ab8c", letterSpacing: "1px", textTransform: "uppercase", marginBottom: 10 }}>EXPERT MARKETPLACE</p>
              ...
              <p style={{ fontSize: 15, color: "#839958", margin: 0 }}>Every expert is verified. Every session is outcome-tracked.</p>
            </div>
            <Link href="/experts" style={{ fontSize: 13, fontWeight: 700, color: "#839958", textDecoration: "none", whiteSpace: "nowrap", flexShrink: 0 }}>
              View all experts →
            </Link>
          </div>
          ...
          <div style={{ display: "flex", gap: 16 }}>
            {experts.map((e, i) => {
              ...
              return (
                <div key={e.id} style={{ flex: "0 0 220px", backgroundColor: "#fff", border: "1px solid #e8e4ce", borderRadius: 16, padding: 20, display: "flex", flexDirection: "column", gap: 12 }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 12, color: "#839958", margin: 0 }}>{e.headline}</p>
                  </div>
                  {(e.expertise_areas ?? []).length > 0 && (
                    <div style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
                      {e.expertise_areas.slice(0, 2).map((tag) => (
                        <span key={tag} style={{ fontSize: 10, fontWeight: 600, backgroundColor: "#e8e4ce", color: "#555", borderRadius: 99, padding: "3px 8px" }}>{tag}</span>
                      ))}
                    </div>
                  )}
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "auto" }}>
                    <span style={{ fontSize: 12, color: "#839958" }}>from ₹{e.minPrice.toLocaleString("en-IN")}</span>
                    <Link href="/experts" style={{ fontSize: 11, fontWeight: 700, backgroundColor: "#0A3323", color: "#839958", borderRadius: 8, padding: "6px 12px", textDecoration: "none" }}>
                      Book session
                    </Link>
                  </div>
                </div>
      ...
      {/* ── How it works ───────────────────────────────────────────────── */}
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "72px 48px" }}>
        <p style={{ fontSize: 11, fontWeight: 700, color: "#b0ab8c", letterSpacing: "1px", textTransform: "uppercase", marginBottom: 12 }}>HOW IT WORKS</p>
        <h2 style={{ fontSize: 32, fontWeight: 800, color: "#1a1a1a", letterSpacing: "-1px", margin: "0 0 48px" }}>Three steps to your next role</h2>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
          {[
            { num: "01", bg: "#F7F4D5", color: "#1a1a1a", emoji: "🎯", title: "Set your goal",            desc: "Tell us your target role. We run a gap analysis and build your roadmap." },
            { num: "02", bg: "#D3968C", color: "#1a1a1a", emoji: "🤖", title: "Use AI to get ready",      desc: "Resume builder, mock interviews, question bank — all free tools to sharpen your edge." },
            { num: "03", bg: "#839958", color: "#0A3323", emoji: "🧑‍💼", title: "Book an expert when ready", desc: "Human layer for what AI can't do — real feedback, real accountability, real results." },
      ...
      {/* ── Testimonial ────────────────────────────────────────────────── */}
      <section style={{ maxWidth: 1100, margin: "0 auto", padding: "0 48px 72px" }}>
        <div style={{ backgroundColor: "#0A3323", borderRadius: 20, padding: "40px 48px", display: "flex", alignItems: "center", gap: 48 }}>
          <div style={{ flex: 1 }}>
            <p style={{ fontSize: 22, fontWeight: 700, color: "#ffffff", lineHeight: 1.65, margin: "0 0 20px" }}>
              ...
              <span style={{ color: "#F7F4D5" }}>PM offer at Zepto</span>
              {" "}6 weeks later.&rdquo;
            </p>
          ...
          <div style={{ textAlign: "center", flexShrink: 0 }}>
            <div style={{ backgroundColor: "#F7F4D5", borderRadius: 16, padding: "24px 32px" }}>
              <p style={{ fontSize: 36, fontWeight: 800, color: "#0A3323", margin: "0 0 2px", lineHeight: 1 }}>+4,500</p>
              <p style={{ fontSize: 15, fontWeight: 800, color: "#0A3323", margin: "0 0 4px" }}>XP</p>
              <p style={{ fontSize: 11, color: "rgba(10,51,35,0.55)", margin: 0 }}>earned on Mentor</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: "#fff", padding: "80px 48px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 16, color: "#839958", margin: "0 0 36px" }}>No credit card. No commitment. Just your next career move.</p>
